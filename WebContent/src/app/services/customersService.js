...
app.service('customersService', function () {
    ...
    this.insertCustomer = function (firstName, lastName, city, dueDate, priority) {
    ...
    var customers = [
        {
            id: 1, firstName: 'Lee', lastName: 'Carroll', address: '1234 Anywhere St.', city: 'Phoenix', dueDate: '01/12/1980', priority : 0,
            orders: [
        ...
        {
            id: 2, firstName: 'Jesse', lastName: 'Hawkins', address: '89 W. Center St.', city: 'Atlanta', dueDate: '01/12/1980', priority : 0,
            orders: [
        ...
        {
            id: 3, firstName: 'Charles', lastName: 'Sutton', address: '455 7th Ave.', city: 'Quebec',  dueDate: '01/12/1980', priority : 0,
            orders: [
        ...
        {
            id: 4, firstName: 'Albert', lastName: 'Einstein', address: '8966 N. Crescent Dr.', city: 'New York City',  dueDate: '01/12/1980', priority : 0,
            orders: [
        ...
        {
            id: 5, firstName: 'Sonya', lastName: 'Williams', address: '55 S. Hollywood Blvd', city: 'Los Angeles',  dueDate: '01/12/1980', priority : 0
        },
        {
            id: 6, firstName: 'Victor', lastName: 'Bryan', address: '563 N. Rainier St.', city: 'Seattle',  dueDate: '01/12/1980', priority : 0,
            orders: [
        ...
        {
            id: 7, firstName: 'Lynette', lastName: 'Gonzalez', address: '25624 Main St.', city: 'Albuquerque',  dueDate: '01/12/1980', priority : 0,
            orders: [
        ...
        {
            id: 8, firstName: 'Erick', lastName: 'Pittman', address: '33 S. Lake Blvd', city: 'Chicago',  dueDate: '01/12/1980', priority : 0,
            orders: [
        ...
        {
            id: 9, firstName: 'Alice', lastName: 'Price', address: '3354 Town', city: 'Cleveland', dueDate: '01/12/1980', priority : 0,
            orders: [
        ...
        {
            id: 10, firstName: 'Gerard', lastName: 'Tucker', address: '6795 N. 53 W. Bills Dr.', city: 'Buffalo', dueDate: '01/12/1980', priority : 0,
            orders: [
        ...
        {
            id: 11, firstName: 'Shanika', lastName: 'Passmore', address: '459 S. International Dr.', city: 'Orlando', dueDate: '01/12/1980', priority : 0,
        }
    ];
